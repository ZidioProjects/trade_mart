...
class TTextTheme {
  ...
  static TextTheme darkTextTheme = TextTheme(
    ...
    titleMedium: const TextStyle().copyWith(fontSize: 24.0, fontWeight: FontWeight.w500, color: Colors.white),
    titleSmall: const TextStyle().copyWith(fontSize: 19.0, fontWeight: FontWeight.w400, color: Colors.white),
    
    bodyLarge: const TextStyle().copyWith(fontSize: 32.0, fontWeight: FontWeight.w500, color: Colors.white),
    bodyMedium: const TextStyle().copyWith(fontSize: 24.0, fontWeight: FontWeight.normal, color: Colors.white),
    bodySmall: const TextStyle().copyWith(fontSize: 19.0, fontWeight: FontWeight.w500, color: Colors.white.withOpacity(0.5)),
